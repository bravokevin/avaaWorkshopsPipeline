 ...
 */
const workshopDetailsCol = (workshop, formUrl) => {
...
${kindOfWorkshop === "Asincrono" ? '' : `<table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  <tbody>
    <tr>
      <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 15px 0px 20px;font-family:'Open Sans',sans-serif;" align="center">
...
<table style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align" style="color: #009640; line-height: 160%; text-align: left; word-wrap: break-word;">
...
<div class="v-text-align" style="color: #DD6F00; line-height: 160%; text-align: center; word-wrap: break-word;">
  <p style="font-size: 16px; line-height: 25.6px;"><strong><span style="font-size: 14px; line-height: 19.6px;">DETALLES EN EL FORMULARIO</span></strong></span></p>
</div>
...
const soloWorkshopDetailsCol = (workshop, formUrl) => {
    const { name, pensum, date, startHour, endHour, speaker, numberOfParticipants, kindOfWorkshop, platform, description, avaaYear } = workshop;
...
<div class="v-text-align" style="color: #009640; line-height: 160%; text-align: center; word-wrap: break-word;">
  <p style="font-size: 14px; line-height: 160%;"><strong><span style="font-size: 16px; line-height: 25.6px;">Modalidad: </span></strong><span style="font-size: 16px; line-height: 25.6px;">${kindOfWorkshop}</span></p>
</div>
...
<table id="u_content_text_29" style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-text-align" style="color: #fcfcfc; line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;">¡Hola, becario! Nos complace <span style="color: #fefeff; font-size: 14px; line-height: 19.6px;"><strong><span style="font-size: 14px; line-height: 19.6px;">invitarte a participar</span></strong></span> en los siguientes talleres de formaci&oacute;n.</p>
<p style="font-size: 14px; line-height: 140%;">&nbsp;</p>
<p style="font-size: 14px; line-height: 140%;">Recuerda confirmar tu asistencia <strong>solo sí estás seguro de poder asistir.</strong></p>
  </div>
 ...
 */
const createGmailHTMLMessage = (values) => {
    let finalhtml = [];
    let dataArr = [];
    // if (values.length === 1) {
