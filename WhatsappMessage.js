...
const createDisplayMessage = () => {
    ...
    if (values[0] === '') {
        //@ts-ignore
        ui.alert("No hay un taller con ese identificador", "Por favor, coloca un identificador de un taller existente", ui.ButtonSet.OK);
    }
    else {
        const response = ui.alert("Tipo de mensaje", "¿Deseas que este mensaje este formateado para WhatsApp?", ui.ButtonSet.YES_NO);
        //@ts-ignore
