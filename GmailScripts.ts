 ...
 */
const convert_ = (object: MessageObj) => {
  const {
    to,
    cc,
    bcc,
 ...
 */
const createMessageObj = (workshopData: WorkshopFinalData[], subject: string, contactGroupName: string) => {
 ...
 * @param contactGroupName the name of the contact group we want to sen de messages
 */
const sendEmails = (workshopData: WorkshopFinalData[], subject: string, contactGroupName: string) => {
